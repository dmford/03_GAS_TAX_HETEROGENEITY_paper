...
merge 1:m statefip using "pciv\PCIV\Application\EstimationData\temp_all.dta", nogen 
...
bootstrap ///
	...
	saving("2000_data\ch3_boot_s`seed'.dta", replace): ch3_boot

timer off 1
timer list

use "2000_data\ch3_boot_s`seed'.dta", clear
